                ...
                if entrada03[0] == '1':
                    while True:
                        ...
                        if Codigo_Mudanca[0].lower() == 'c':
                            ...
                            Conta_Mudanca = ponteiro.fetchone() #Talvez tenha que adicionar um passo extra.
                    ...
                    Conta_Mudanca = str(input(">Insira o ID ou CPF de uma conta desligada. [Digite 'cancel' para voltar]: "))
                elif entrada03[0] == '3':
                    print (' ')
                elif entrada03[0] == '4':
                    Escolha_Valida = False
