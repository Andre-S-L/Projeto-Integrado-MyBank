...
if entrada01 == '1' or entrada01.lower() == 'login':
    ...
    while True:
        ...
        if not Usuario_Validacao:
            ...
            if list(Usuario_Senha) == Usuario_Validacao: #Isso não funciona porque o Usuario_Validação conta como um tipo List, e o Usuario_Senha como um tipo String.
                ...
                print ('Bem-Vindo de volta', Nome_Mostrado, 'a sua conta MyBank!')
                Login_Valido = True
            else:
