            ...
            while Destin_Localizado == False:
                ...
                if len(Destinatario) == 14:
                    ...
                    if not Destinatario_Valido:
                        ...
                        print ('O destinatario de sua transferencia é o usuario: '+str(Destinatario_Valido[1])+', Usuario de ID '+str(Destinatario[0])+', CPF'+str(Destinatario[2])+'.')
                        while True:
                    ...
                    if not Destinatario_Valido:
                        ...
                        print ('O destinatario de sua transferencia é o usuario: '+str(Destinatario_Valido[1])+' Usuario de ID '+str(Destinatario[0]+'.'))
                        while True:
                            Confirmacao_Transferencia_1 = str(input('>Isto esta correto? [Y/N]: '))
                            if Confirmacao_Transferencia_1.lower == 'y':
                                Destin_Localizado = True
