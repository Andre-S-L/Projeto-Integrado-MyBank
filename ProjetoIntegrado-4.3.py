  ...
  if entrada01 == '1' or entrada01[0].lower() == 'l':
    ...
    while True:
        ...
        if Login_Usuario == 'cancel':
          ...
          ponteiro.execute("SELECT tbl_conta.Conta_ID, tbl_cliente.Cliente_Admin FROM tbl_conta INNER JOIN tbl_cliente WHERE tbl_conta.Conta_Ativa = 1 AND tbl_cliente.Cliente_CPF = '"+str(Login_Usuario)+"';")
