                ...
                if Transferencia_Valor == 'Cancel':
                    ...
                    while PIN_Valido == False:
                      ...
                      if str(PIN_Correto) == "("+PIN_Tentativa+",)":
                        PIN_Valido = True
                        print ('Atenção. Você esta transferindo R$'+str(Transferencia_Valor)+' para '+str(Destinatario_Valido[1])+', ID '+str(Destinatario[0])+'. Seu saldo restante após a transferencia será de'+str(float(VALOR_Conta_Usuario)-float(Transferencia_Valor))+'.')
