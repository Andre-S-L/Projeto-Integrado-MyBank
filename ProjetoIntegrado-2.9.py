                      ...
                      while True:
                            if float(str(Emprestimo_Existente[7])) <= float(str(Quantia_Atual[0])):
                                ...
                                if Confirmacao_Devolucao2[0].lower() == 'c':
                                    ...
                                    ponteiro.execute("UPDATE tbl_emprestimo SET Emprestimo_Ativo = '0', Emprestimo_Data_Devol = '"+str(datetime.datetime.today())+"', Emprestimo_Tempo_Corrido_Dias = '""';")
                                    ponteiro.execute("UPDATE tbl_agencia")
                                else:
